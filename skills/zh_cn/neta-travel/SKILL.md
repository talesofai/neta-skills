...
| 信号 | 模式 | 加载 |
|------|------|------|
| 用户想要创建 / 设计 / 构建故事 | 创作 | `references/travel-crafting.md` |
| 用户提供 UUID 或提及已有剧本 | 游玩 | `references/travel-playing.md` |
| 创作或游玩中出现字段相关问题 | — | `references/travel-field-guide.md` |
...
📖 [创作工作流](./references/travel-crafting.md) — 先出草稿的循环、字段体系、质量自检。
...
📖 [游玩工作流](./references/travel-playing.md) — 会话初始化、主动推进、方向操控机制。
...
| 📋 字段语义 | [travel-field-guide.md](./references/travel-field-guide.md) |
| ✨ 跨类型完整范例 | [travel-examples.md](./references/travel-examples.md) |
