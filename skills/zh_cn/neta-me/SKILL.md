---
name: neta-me
description: Neta API 用户技能 — 管理自己的身份、积分和个人资产（资料、AP、作品）。当用户询问「我的账号」「我的图片」「我的 AP」或与自身 Neta 身份及创作相关的问题时使用此技能。
---

# Neta 用户技能

当前 Neta 用户的自助服务仪表盘。提供身份、积分余额/历史以及个人内容资产（作品）的访问能力。
...
| 🖼️ 作品 | [assets.md](./references/assets.md) |
