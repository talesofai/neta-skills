...
**推荐流获取**
```bash
npx -y @talesofai/neta-skills request_interactive_feed --page_index 0 --page_size 3
```
...
**获取标签角色**
```bash
npx -y @talesofai/neta-skills get_hashtag_characters --hashtag "标签名" --sort_by "hot"
```
